...
export default function RegisterPage() {
    ...
    switch (step) {
      case 1:
        if (!username.trim() || !email.trim() || !password.trim()) {
          showAlert("Error", "Please fill in all account credentials", [{ text: 'OK' }], 'warning');
          return false;
        }
        if (password.length < 6) {
          showAlert("Error", "Password must be at least 6 characters", [{ text: 'OK' }], 'warning');
          return false;
        }
        return true;
      case 2:
        if (!firstName.trim() || !lastName.trim() || !phone.trim() || !dateOfBirth.trim() || !gender.trim()) {
          showAlert("Error", "Please fill in all personal information", [{ text: 'OK' }], 'warning');
          return false;
        }
        return true;
      case 3:
        if (!bloodType.trim()) {
          showAlert("Error", "Please select your blood type", [{ text: 'OK' }], 'warning');
          return false;
        }
        return true;
      default:
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      showAlert("Registration Successful", "Your account has been created! You can now login.", [
        { text: "OK", onPress: () => router.replace("/login") },
      ], 'success');
    } catch (error) {
      // Error already handled, no console log needed
      showAlert(
        "Registration Failed",
                      ...
                      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' }}>
                        <View style={{ backgroundColor: 'white', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 16 }}>
                          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                            ...
                            <Text style={{ fontSize: 17, fontWeight: '600', color: '#1f2937' }}>Select Date</Text>
                            <TouchableOpacity onPress={() => setShowDatePicker(false)}>
                            ...
                            >
                              <View style={{ alignItems: 'center' }}>
                                <Ionicons 
                                  ...
                                  color="white"
                                />
                                <Text style={{ textAlign: 'center', fontWeight: '700', marginTop: 6, color: 'white' }}>
                                  {option.label}
                                </Text>
                              </View>
                            </LinearGradient>
                            ...
                            <View style={{
                              ...
                              <View style={{ alignItems: 'center' }}>
                                <Ionicons 
                                  ...
                                  color="#6b7280"
                                />
                                <Text style={{ textAlign: 'center', fontWeight: '700', marginTop: 6, color: '#374151' }}>
                                  {option.label}
                                </Text>
                              </View>
                            </View>
            ...
            onPress={() => setBloodType(type)}
                        ...
                        >
                          {isSelected ? (
                            ...
                            >
                              ...
                              <Text style={{ fontWeight: '700', fontSize: 17, marginTop: 4, color: 'white' }}>
                                {type}
                              </Text>
                            </LinearGradient>
                          ) : (
                            <View style={{
                              ...
                              <Text style={{ fontWeight: '700', fontSize: 17, marginTop: 4, color: '#1f2937' }}>
              {type}
            </Text>
                            </View>
                          )}
                  ...
                  <View style={{
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <Text style={{ fontSize: 11, color: '#1e40af', marginLeft: 8, flex: 1 }}>
              ...
              <View style={{ marginTop: 24 }}>
                ...
                <TouchableOpacity
                  ...
                  disabled={loading}
                  style={{
                    backgroundColor: loading ? '#9ca3af' : currentStep === 3 ? '#10b981' : '#3b82f6',
                    padding: 18,
                    borderRadius: 16,
                    alignItems: 'center',
                ...
                {/* Back/Cancel Button */}
                <TouchableOpacity
                  onPress={currentStep === 1 ? () => router.push("/login") : handleBack}
                  style={{
                    backgroundColor: 'white',
                    paddingVertical: 14,
