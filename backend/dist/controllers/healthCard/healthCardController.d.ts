...
declare const getAllHealthCardsByUserId: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
...
declare const downloadVaccinationCertificate: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
