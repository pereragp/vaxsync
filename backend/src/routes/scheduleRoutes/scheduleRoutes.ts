...
router.post(
  ...
  validateRequest,
  ScheduleController.createVaccineSchedule
);
...
router.put(
  ...
  validateRequest,
  ScheduleController.updateVaccineSchedule
);

// PUT /api/v1/schedule/:scheduleId/doses/:doseNumber - Update dose status
router.put(
  "/:scheduleId/doses/:doseNumber",
  updateDoseValidation,
  validateRequest,
...
router.delete(
  ...
  scheduleIdValidation,
  validateRequest,
  ScheduleController.deleteVaccineSchedule
);
